...
# Configuration
INPUT_FILE = 'raw_data/top_100_from_2000_to_2023.csv'
OUTPUT_FILE = 'raw_data/spotify2000-2023_enriched_with_countries.csv'
REPORT_FILE = 'raw_data/enrichment_report_top_100.txt'
